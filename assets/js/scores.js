...
let lessonTotalQNA = 6; //from server in full lunch //Get 6 json each at every turn
        ...
        success: function(data){    
           //$("#main").html(data); 
            if(data == "1001"){ //IF USER IS LOGGED IN
				...
				removeCookies();
				document.getElementById('mainAppArea').innerHTML = `Seems you have you have stumbled into an unfamiliar territory. Go back to dashboard to find your way.`;
            }
